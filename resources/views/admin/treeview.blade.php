...
<!--Internal  treeview -->
<link href="{{URL::asset('assets/admin/plugins/treeview/treeview-rtl.css')}}" rel="stylesheet" type="text/css" />
@endsection
@section('page-header')
				<!-- breadcrumb -->
...
<script src="{{URL::asset('assets/admin/plugins/treeview/treeview.js')}}"></script>
@endsection