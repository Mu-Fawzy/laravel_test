...
<link href="{{URL::asset('assets/admin/plugins/inputtags/inputtags.css')}}" rel="stylesheet">
<!--- Custom-scroll -->
...
src="{{URL::asset('assets/admin/plugins/tabs/jquery.multipurpose_tabcontent.js')}}"</script></code></pre>
<div class="clipboard-icon" data-clipboard-target="#element5"><i class="las la-clipboard"></i></div>
</figure>
										</div>
