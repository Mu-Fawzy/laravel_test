...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">Posts</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ Create</span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
...
@section('content')
            ...
            <form class="row row-sm" action="{{ route('posts.store') }}" method="POST" id="form_post" enctype="multipart/form-data">
                @csrf
                        ...
                        <div class="card-body">
                            <div class="mb-5">
                                ...
                                <div class="row row-sm">
                                    <div class="col-lg">
                                        <input class="form-control @error('title') parsley-error @enderror" placeholder="Post Title" name="title" type="text" value="{{ old('title') }}">
                                        @error('title')
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="mb-0">
                                ...
                                <div class="row row-sm">
                                    <div class="col-lg">
                                        <textarea class="form-control" placeholder="Post Description" rows="3" name="description">{{ old('description') }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card mg-b-20 mg-md-b-0">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-0">
                                ...
                                <div>
                                    <input type="file" name="image" class="dropify @error('image') parsley-error @enderror" data-default-file="{{URL::asset('assets/admin/img/photos/1.jpg')}}" data-height="200"  />
                                    @error('image')
                                        <ul class="parsley-errors-list filled" id="parsley-id-11">
                                            <li class="parsley-required">{{ $message }}</li>
                                        </ul>
