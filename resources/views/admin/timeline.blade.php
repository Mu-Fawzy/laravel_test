...
<link href="{{URL::asset('assets/admin/plugins/timeline/css/timeline.min.css')}}" rel="stylesheet">
@endsection
@section('page-header')
				<!-- breadcrumb -->
							...
							<div class="card-body">
								<div class="vtimeline">
									<div class="timeline-wrapper timeline-wrapper-primary">
										<div class="timeline-badge success"><img class="timeline-image" alt="img" src="{{URL::asset('assets/admin/img/faces/3.jpg')}}"> </div>
									...
									<div class="timeline-wrapper timeline-inverted timeline-wrapper-danger">
										<div class="timeline-badge success"><img class="timeline-image" alt="img" src="{{URL::asset('assets/admin/img/faces/12.jpg')}}"> </div>
										<div class="timeline-panel">
											<div class="timeline-heading">
											...
											<div class="timeline-body">
												...
												<img src="{{URL::asset('assets/admin/img/media/4.jpg')}}" class="mb-3" alt="img">
											</div>
											<div class="timeline-footer d-flex align-items-center flex-wrap">
												<i class="fe fe-heart  text-muted ml-1"></i>
												<span>19</span>
									...
									<div class="timeline-wrapper timeline-inverted timeline-wrapper-warning">
										<div class="timeline-badge success"><img class="timeline-image" alt="img" src="{{URL::asset('assets/admin/img/faces/15.jpg')}}"> </div>
										<div class="timeline-panel">
											<div class="timeline-heading">
