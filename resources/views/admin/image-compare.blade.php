...
<link href="{{URL::asset('assets/admin/plugins/images-comparsion/twentytwenty.css')}}" rel="stylesheet" />
@endsection
@section('page-header')
				<!-- breadcrumb -->
						...
						<div class="card mg-b-20">
							<div class="card-body">
								...
								<div class="twentytwenty-container">
									<img src="{{URL::asset('assets/admin/img/photos/compare1.jpg')}}" alt="img" />
									<img src="{{URL::asset('assets/admin/img/photos/compare2.jpg')}}" alt="img" />
								</div>
							</div>
						</div>
						<!-- div -->
