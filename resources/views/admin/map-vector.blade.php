...
<script src="{{URL::asset('assets/admin/plugins/jqvmap/maps/jquery.vmap.world.js')}}"></script>
<script src="{{URL::asset('assets/admin/plugins/jqvmap/maps/jquery.vmap.usa.js')}}"></script>
<script src="{{URL::asset('assets/admin/plugins/jqvmap/maps/jquery.vmap.canada.js')}}"></script>
<script src="{{URL::asset('assets/admin/plugins/jqvmap/maps/jquery.vmap.algeria.js')}}"></script>
<script src="{{URL::asset('assets/admin/plugins/jqvmap/maps/jquery.vmap.argentina.js')}}"></script>
<script src="{{URL::asset('assets/admin/plugins/jqvmap/maps/jquery.vmap.europe.js')}}"></script>
