...
<link href="{{URL::asset('assets/admin/plugins/fullcalendar/fullcalendar.min.css')}}" rel="stylesheet">
@endsection
@section('page-header')
				<!-- breadcrumb -->
							...
							<div class=" card card--calendar p-0 mg-b-20">
								<div class="p-4 border-bottom">
									...
									<div class="text-center mx-auto">
										<img src="{{URL::asset('assets/admin/img/media/calendar.png')}}" alt="calendar" class="ht-80p wd-80p">
									</div>
								</div>
...
@section('js')
<!-- moomet min js -->
<script src="{{URL::asset('assets/admin/plugins/moment/min/moment.min.js')}}"></script>
...
<script src="{{URL::asset('assets/admin/plugins/fullcalendar/fullcalendar.min.js')}}"></script>
