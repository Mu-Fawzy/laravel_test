...
{{-- headerhome --}}
@include('layouts.site.includes.headerhome')
                    ...
                    <div class="swiper-container image-slider">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                    <img class="img-fluid" src="{{ URL::asset('assets/site/images/customer-logo-1.png') }}" alt="alternative">
                            </div>
                            <div class="swiper-slide">
                                    <img class="img-fluid" src="{{ URL::asset('assets/site/images/customer-logo-2.png') }}" alt="alternative">
                            </div>
                            <div class="swiper-slide">
                                    <img class="img-fluid" src="{{ URL::asset('assets/site/images/customer-logo-3.png') }}" alt="alternative">
                            </div>
                            <div class="swiper-slide">
                                    <img class="img-fluid" src="{{ URL::asset('assets/site/images/customer-logo-4.png') }}" alt="alternative">
                            </div>
                            <div class="swiper-slide">
                                    <img class="img-fluid" src="{{ URL::asset('assets/site/images/customer-logo-5.png') }}" alt="alternative">
                            </div>
                            <div class="swiper-slide">
                                    <img class="img-fluid" src="{{ URL::asset('assets/site/images/customer-logo-6.png') }}" alt="alternative">
                            </div>
            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-image">
                        <img class="img-fluid" src="{{ URL::asset('assets/site/images/description-1.png') }}" alt="alternative">
                    </div>
                    <div class="card-body">
                ...
                <div class="card">
                    <div class="card-image">
                        <img class="img-fluid" src="{{ URL::asset('assets/site/images/description-2.png') }}" alt="alternative">
                    </div>
                    <div class="card-body">
                ...
                <div class="card">
                    <div class="card-image">
                        <img class="img-fluid" src="{{ URL::asset('assets/site/images/description-3.png') }}" alt="alternative">
                    </div>
                    <div class="card-body">
                ...
                <div class="tab-content" id="argoTabsContent">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="image-container">
                                    <img class="img-fluid" src="{{ URL::asset('assets/site/images/features-1.png') }}" alt="alternative">
                    ...
                    <div class="tab-pane fade" id="tab-2" role="tabpanel" aria-labelledby="tab-2">
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="image-container">
                                    <img class="img-fluid" src="{{ URL::asset('assets/site/images/features-2.png') }}" alt="alternative">
                                </div> <!-- end of image-container -->
                            </div> <!-- end of col -->
                            <div class="col-lg-6">
                                <div class="text-container">
                    ...
                    <div class="tab-pane fade" id="tab-3" role="tabpanel" aria-labelledby="tab-3">
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="image-container">
                                    <img class="img-fluid" src="{{ URL::asset('assets/site/images/features-3.png') }}" alt="alternative">
                                </div> <!-- end of image-container -->
                            </div> <!-- end of col -->
                            <div class="col-lg-6">
                                <div class="text-container">
...
<div id="details-lightbox-1" class="lightbox-basic zoom-anim-dialog mfp-hide">
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-8">
                <div class="image-container">
                    <img class="img-fluid" src="{{ URL::asset('assets/site/images/details-lightbox.png') }}" alt="alternative">
                </div> <!-- end of image-container -->
            </div> <!-- end of col -->
            <div class="col-lg-4">
                <h3>List Building</h3>
                ...
                <div class="image-container">
                    <div class="video-wrapper">
                        <a class="popup-youtube" href="https://www.youtube.com/watch?v=fLCjQJCekTs" data-effect="fadeIn">
                            <img class="img-fluid" src="{{ URL::asset('assets/site/images/video-image.png') }}" alt="alternative">
                        ...
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide">
                                <div class="image-wrapper">
                                    <img class="img-fluid" src="{{ URL::asset('assets/site/images/testimonial-1.jpg') }}" alt="alternative">
                            ...
                            <div class="swiper-slide">
                                <div class="image-wrapper">
                                    <img class="img-fluid" src="{{ URL::asset('assets/site/images/testimonial-2.jpg') }}" alt="alternative">
                                </div> <!-- end of image-wrapper -->
                                <div class="text-wrapper">
                            ...
                            <div class="swiper-slide">
                                <div class="image-wrapper">
                                    <img class="img-fluid" src="{{ URL::asset('assets/site/images/testimonial-3.jpg') }}" alt="alternative">
                                </div> <!-- end of image-wrapper -->
                                <div class="text-wrapper">
                            ...
                            <div class="swiper-slide">
                                <div class="image-wrapper">
                                    <img class="img-fluid" src="{{ URL::asset('assets/site/images/testimonial-4.jpg') }}" alt="alternative">
                                </div> <!-- end of image-wrapper -->
                                <div class="text-wrapper">
